...
sudo ln -s /var/www/$PROJECT_NAME/config/uwsgi/$PROJECT_NAME-uwsgi.service /etc/systemd/system/$PROJECT_NAME-uwsgi.service

# Start uwsgi
sudo systemctl start $PROJECT_NAME-uwsgi
sudo systemctl enable $PROJECT_NAME-uwsgi
